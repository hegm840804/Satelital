...
import styles from "./ModalPrepagoConTarjeta.module.css";
    ...
    if (p_card === null || typeof p_card === "undefined") {
      ...
      if (
        ...
        if(otherQuantity.length === 0 && saldoAPagar === "0"){
          setStatus("ERROR");
          setMessage("Su saldo es 0, favor de ingresar un valor en Otra Cantidad");
          setShowAlert(true);
          setTimeout(() => {
            setShowAlert(false);
          }, 3000);
              ...
              <Row className={styles["alignCenterCenterColumn4TotalPagar"]}>
                ...
                >
                  <Form.Group className={styles["confirmPaymentInputText"]}>
                    <Form.Label>Total a recargar:</Form.Label>
