...
import banner from "../assets/img/Banners/descarga_skymas.jpg";
import bannerSmall from "../assets/img/Banners/descarga_skymas-appmobile.jpg";
import { Container } from "react-bootstrap";

export const BannerSkyPlusDescarga = () => {
  return (
    <>
      <Container
        id="big"
